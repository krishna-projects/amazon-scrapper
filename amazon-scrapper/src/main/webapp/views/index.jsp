...
<body onload="enableCheck()">
	...
	<div class="container mt-5">
		...
		<label class="text-primary">${product.affUrl}</label> <br> <label
			id="msg" class="text-danger"></label>
		<div class="row mt-5">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<form action="save-to-database" method="post">
					...
					<div class="form-group">
						<label>ASIN Product Id</label> <input type="text"
							class="form-control" value="${product.pid}" name="rating"
